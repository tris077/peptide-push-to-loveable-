            ...
            <div className="flex items-center gap-3">
              <Button
                ...
                className={`text-white hover:bg-white/20 rounded-full transition-all duration-300 ${
                  isFavorited ? 'bg-pink-500/20 hover:bg-pink-500/30' : ''
                }`}
              >
                <Heart className={`h-4 w-4 ${isFavorited ? 'fill-current text-pink-400' : ''}`} />
              </Button>
              <Button
                variant="ghost"
                size="sm"
