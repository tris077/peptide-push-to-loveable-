...
export const peptidesData: Peptide[] = [
  ...
  },
  {
    ...
    fullDescription: "PT-141 (Bremelanotide) is a synthetic peptide that activates melanocortin receptors in the brain to enhance sexual desire and arousal in both men and women through central nervous system mechanisms. Unlike PDE5 inhibitors, it works directly on the brain's sexual response pathways rather than blood flow. Research demonstrates significant improvements in sexual function and desire.",
    mechanismOfAction: "Activates melanocortin-4 receptors in the brain to enhance sexual motivation and arousal. Modulates neural pathways involved in sexual response and desire through central nervous system mechanisms.",
  ...
  },
  {
    ...
    name: "IGF-2",
    category: ["Muscle Growth & Definition", "Skin Regeneration & Anti-Aging"],
    shortDescription: "Insulin-like growth factor 2 that promotes cellular growth and development.",
    fullDescription: "IGF-2 (Insulin-like Growth Factor 2) is a naturally occurring peptide hormone that plays a crucial role in fetal development and continues to have effects throughout life. It promotes cellular growth, differentiation, and survival through interaction with IGF receptors. Research demonstrates significant benefits for muscle development, tissue repair, and metabolic regulation.",
    mechanismOfAction: "Binds to IGF-1 and IGF-2 receptors to activate intracellular signaling pathways that promote cell growth, differentiation, and survival. Modulates glucose metabolism and protein synthesis.",
    useCases: ["Muscle Development", "Tissue Repair", "Metabolic Regulation", "Cellular Growth"],
    benefits: ["Enhanced muscle growth", "Improved tissue repair", "Better metabolic function", "Increased cellular proliferation"],
    dosageRange: "50-200 mcg daily",
    administration: ["Subcutaneous"],
    halfLife: "2-4 hours",
    sources: [
      {
    ...
    warnings: ["Research purposes only", "Monitor blood glucose levels"],
    sideEffects: ["Hypoglycemia", "Water retention", "Joint pain", "Possible tumor growth"],
    molecularFormula: "C333H529N91O99S6",
    molecularWeight: "7471.0 g/mol",
    atomCount: 1058,
    yearDiscovered: "1978",
    legalStatus: "Research Only (US/EU)",
    structure2D: "/placeholder-molecule.svg"
  },
  {
    id: "desmopressin",
    name: "Desmopressin",
    category: ["Mood & Cognition Enhancement", "Sleep Enhancement"],
    shortDescription: "A synthetic vasopressin analog that improves memory and cognitive function.",
    fullDescription: "Desmopressin is a synthetic analog of vasopressin, a naturally occurring hormone that regulates water retention and blood pressure. Research indicates it can improve memory consolidation, enhance learning capacity, and potentially improve sleep quality. It's also used in research for its effects on social behavior and emotional processing.",
    mechanismOfAction: "Binds to vasopressin receptors in the brain to modulate memory consolidation, learning processes, and social behavior. Regulates water balance and blood pressure.",
    useCases: ["Memory Enhancement", "Learning Improvement", "Sleep Quality", "Social Behavior Research"],
    benefits: ["Improved memory", "Enhanced learning", "Better sleep quality", "Potential social enhancement"],
    dosageRange: "10-40 mcg daily",
    administration: ["Sublingual", "Intranasal"],
    ...
    warnings: ["Research purposes only", "Monitor blood pressure", "Avoid excessive water intake"],
    sideEffects: ["Headache", "Nausea", "Water retention", "Possible blood pressure changes"],
    molecularFormula: "C46H64N14O12S2",
    molecularWeight: "1069.22 g/mol",
    atomCount: 148,
    yearDiscovered: "1972",
    legalStatus: "Prescription (US/EU), Research Available",
    structure2D: "/placeholder-molecule.svg"
  },
  {
    id: "hgh",
    name: "Human Growth Hormone",
    category: ["Muscle Growth & Definition", "Skin Regeneration & Anti-Aging", "Fat Loss & Recomposition"],
    shortDescription: "The master hormone that regulates growth, metabolism, and cellular regeneration.",
    fullDescription: "Human Growth Hormone (HGH) is a peptide hormone produced by the pituitary gland that plays a central role in growth, metabolism, and cellular regeneration. It stimulates the production of IGF-1, promotes protein synthesis, enhances fat metabolism, and supports tissue repair. Research demonstrates profound effects on body composition, recovery, and anti-aging processes.",
    mechanismOfAction: "Binds to growth hormone receptors throughout the body to stimulate IGF-1 production, enhance protein synthesis, promote fat oxidation, and support cellular regeneration and repair.",
    useCases: ["Muscle Development", "Fat Loss", "Anti-Aging", "Recovery Enhancement", "Tissue Repair"],
    benefits: ["Increased muscle mass", "Enhanced fat loss", "Improved recovery", "Better skin quality", "Enhanced energy"],
    dosageRange: "1-4 IU daily",
    administration: ["Subcutaneous"],
    halfLife: "2-3 hours",
    sources: [
      {
    ...
    warnings: ["Research purposes only", "Requires medical supervision", "Monitor blood glucose"],
    sideEffects: ["Joint pain", "Water retention", "Carpal tunnel syndrome", "Possible diabetes risk"],
    molecularFormula: "C990H1528N262O300S7",
    molecularWeight: "22124.0 g/mol",
    atomCount: 3087,
    yearDiscovered: "1921",
    legalStatus: "Prescription Only (US/EU)",
    structure2D: "/placeholder-molecule.svg"
  },
  {
    id: "fragment-176-191",
    ...
    category: ["Fat Loss & Recomposition"],
    shortDescription: "A modified fragment of HGH that specifically targets fat loss without muscle loss.",
    fullDescription: "Fragment 176-191 is a modified fragment of human growth hormone that specifically targets fat metabolism without the muscle-building effects of full HGH. It works by enhancing lipolysis (fat breakdown) and inhibiting lipogenesis (fat formation). Research demonstrates significant fat loss while preserving lean muscle mass.",
    mechanismOfAction: "Enhances lipolysis by stimulating hormone-sensitive lipase and inhibits lipogenesis through modulation of fat cell metabolism. Does not bind to growth hormone receptors.",
    useCases: ["Fat Loss", "Body Recomposition", "Metabolic Enhancement", "Weight Management"],
    benefits: ["Targeted fat loss", "Muscle preservation", "Improved metabolism", "No HGH side effects"],
    dosageRange: "250-500 mcg daily",
    administration: ["Subcutaneous"],
    halfLife: "30 minutes",
    sources: [
      {
        name: "Fat Loss Research",
        url: "#",
        disclaimer: "External Site - Not Affiliated"
      }
    ],
    warnings: ["Research purposes only", "Monitor for injection site reactions"],
    sideEffects: ["Injection site reactions", "Mild fatigue", "Possible water retention"],
    molecularFormula: "C78H123N21O23S",
    molecularWeight: "1746.0 g/mol",
    atomCount: 245,
    yearDiscovered: "1990s",
    legalStatus: "Research Only (US/EU)",
    structure2D: "/placeholder-molecule.svg"
  },
  {
    id: "cortagen",
    name: "Cortagen",
    category: ["Mood & Cognition Enhancement", "Stress Reduction"],
    shortDescription: "A synthetic peptide that modulates cortisol and stress response.",
    fullDescription: "Cortagen is a synthetic peptide designed to modulate cortisol levels and improve stress response. It works by regulating the hypothalamic-pituitary-adrenal (HPA) axis to normalize cortisol production and improve stress resilience. Research demonstrates benefits for mood, cognitive function, and overall stress management.",
    mechanismOfAction: "Modulates HPA axis function to normalize cortisol production and improve stress response. Enhances stress resilience and cognitive function through neuroendocrine regulation.",
    useCases: ["Stress Management", "Mood Enhancement", "Cognitive Function", "HPA Axis Regulation"],
    benefits: ["Reduced stress", "Improved mood", "Better cognitive function", "Enhanced stress resilience"],
    dosageRange: "100-300 mcg daily",
    administration: ["Subcutaneous"],
    halfLife: "2-4 hours",
    sources: [
    ...
    warnings: ["Research purposes only", "Monitor cortisol levels"],
    sideEffects: ["Mild fatigue", "Dizziness", "Possible mood changes"],
    molecularFormula: "C45H62N12O8",
    molecularWeight: "922.04 g/mol",
    atomCount: 127,
    yearDiscovered: "2000s",
    legalStatus: "Research Only (US/EU)",
    structure2D: "/placeholder-molecule.svg"
  },
  {
    id: "thymalin",
    name: "Thymalin",
    category: ["Immune Enhancement", "Anti-Aging", "Wound Healing & Recovery"],
    shortDescription: "A thymic peptide that enhances immune function and cellular regeneration.",
    fullDescription: "Thymalin is a peptide complex derived from the thymus gland that plays a crucial role in immune system regulation and cellular regeneration. It stimulates T-cell production, enhances immune response, and promotes tissue repair. Research demonstrates significant benefits for immune function, anti-aging, and recovery processes.",
    mechanismOfAction: "Stimulates thymus function to enhance T-cell production and maturation. Modulates immune response and promotes cellular regeneration through growth factor stimulation.",
    useCases: ["Immune Enhancement", "Anti-Aging", "Recovery Improvement", "Tissue Repair"],
    benefits: ["Enhanced immune function", "Improved recovery", "Anti-aging effects", "Better tissue repair"],
    dosageRange: "10-50 mg daily",
    administration: ["Subcutaneous", "Intramuscular"],
    halfLife: "Several hours",
    sources: [
      {
    ...
    warnings: ["Research purposes only", "Monitor immune response"],
    sideEffects: ["Injection site reactions", "Mild fever", "Possible immune activation"],
    molecularFormula: "Variable",
    molecularWeight: "Variable",
    atomCount: 0,
    yearDiscovered: "1970s",
    legalStatus: "Research Only (US/EU)",
    structure2D: "/placeholder-molecule.svg"
  },
  {
    id: "gonadorelin",
    name: "Gonadorelin",
    category: ["Hormone Regulation", "Libido & Sexual Function"],
    shortDescription: "A gonadotropin-releasing hormone that regulates reproductive hormones.",
    fullDescription: "Gonadorelin is a synthetic form of gonadotropin-releasing hormone (GnRH) that stimulates the production of luteinizing hormone (LH) and follicle-stimulating hormone (FSH). It plays a crucial role in regulating reproductive hormones and can be used to restore natural hormone production. Research demonstrates benefits for hormone balance and reproductive health.",
    mechanismOfAction: "Binds to GnRH receptors in the pituitary gland to stimulate the release of LH and FSH, which regulate testosterone, estrogen, and other reproductive hormones.",
    useCases: ["Hormone Regulation", "Testosterone Restoration", "Reproductive Health", "Hormone Balance"],
    benefits: ["Restored hormone production", "Improved reproductive health", "Better hormone balance", "Natural hormone stimulation"],
    dosageRange: "100-500 mcg daily",
    administration: ["Subcutaneous"],
    ...
    warnings: ["Research purposes only", "Monitor hormone levels"],
    sideEffects: ["Hormone fluctuations", "Mood changes", "Possible acne"],
  ...
  },
  {
    id: "erythropoietin",
    name: "Erythropoietin",
    category: ["Performance Enhancement", "Recovery Improvement"],
    shortDescription: "A hormone that stimulates red blood cell production and oxygen delivery.",
    fullDescription: "Erythropoietin (EPO) is a glycoprotein hormone that stimulates red blood cell production in the bone marrow. It increases oxygen-carrying capacity, improves endurance, and enhances recovery. Research demonstrates significant benefits for athletic performance, recovery, and oxygen utilization.",
    mechanismOfAction: "Binds to erythropoietin receptors on bone marrow cells to stimulate red blood cell production and maturation. Increases oxygen-carrying capacity and improves tissue oxygenation.",
    useCases: ["Performance Enhancement", "Endurance Improvement", "Recovery Enhancement", "Oxygen Utilization"],
    benefits: ["Increased endurance", "Better recovery", "Improved oxygen delivery", "Enhanced performance"],
    dosageRange: "10-50 IU/kg 2-3x weekly",
    ...
    warnings: ["Research purposes only", "Monitor hematocrit levels", "Risk of blood clots"],
    sideEffects: ["Increased blood viscosity", "Risk of thrombosis", "Hypertension"],
    molecularFormula: "C809H1301N229O240S5",
    molecularWeight: "18399.0 g/mol",
    atomCount: 2584,
    yearDiscovered: "1977",
    legalStatus: "Prescription Only (US/EU)",
    structure2D: "/placeholder-molecule.svg"
  },
  {
    id: "nad-plus",
    name: "NAD+",
    category: ["Anti-Aging", "Energy Enhancement", "Cellular Repair"],
    shortDescription: "Nicotinamide adenine dinucleotide that powers cellular energy and repair processes.",
    fullDescription: "NAD+ (Nicotinamide Adenine Dinucleotide) is a coenzyme found in all living cells that plays a crucial role in energy metabolism, DNA repair, and cellular signaling. It's essential for mitochondrial function and cellular repair processes. Research demonstrates significant benefits for anti-aging, energy production, and cellular health.",
    mechanismOfAction: "Acts as a coenzyme in redox reactions, powers mitochondrial energy production, and serves as a substrate for enzymes involved in DNA repair and cellular signaling.",
    useCases: ["Anti-Aging", "Energy Enhancement", "Cellular Repair", "Mitochondrial Health"],
    benefits: ["Enhanced energy", "Improved cellular repair", "Anti-aging effects", "Better mitochondrial function"],
    dosageRange: "100-500 mg daily",
    ...
    warnings: ["Research purposes only", "Monitor for side effects"],
    sideEffects: ["Nausea", "Headache", "Flushing", "Possible liver effects"],
    molecularFormula: "C21H27N7O14P2",
    molecularWeight: "663.43 g/mol",
    atomCount: 71,
    yearDiscovered: "1906",
    legalStatus: "Research Available (US/EU)",
    structure2D: "/placeholder-molecule.svg"
  },
  {
    id: "nmn",
    name: "NMN",
    category: ["Anti-Aging", "Energy Enhancement", "Cellular Repair"],
    shortDescription: "Nicotinamide mononucleotide that boosts NAD+ levels and cellular energy.",
    fullDescription: "NMN (Nicotinamide Mononucleotide) is a precursor to NAD+ that plays a crucial role in cellular energy production and repair processes. It's converted to NAD+ in the body and supports mitochondrial function, DNA repair, and cellular signaling. Research demonstrates significant benefits for anti-aging, energy production, and overall cellular health.",
    mechanismOfAction: "Converted to NAD+ in the body to support mitochondrial energy production, DNA repair enzymes, and cellular signaling pathways.",
    useCases: ["Anti-Aging", "Energy Enhancement", "Cellular Repair", "Mitochondrial Health"],
    benefits: ["Increased NAD+ levels", "Enhanced energy", "Improved cellular repair", "Anti-aging effects"],
    dosageRange: "250-1000 mg daily",
    administration: ["Oral", "Sublingual"],
    halfLife: "Several hours",
    sources: [
      {
  ...
  },
  {
    id: "p21",
    name: "P21",
    category: ["Anti-Aging", "Cellular Repair", "Longevity"],
    shortDescription: "A peptide that activates cellular repair and anti-aging pathways.",
    fullDescription: "P21 is a synthetic peptide that activates cellular repair mechanisms and anti-aging pathways. It works by stimulating the production of growth factors and activating cellular regeneration processes. Research demonstrates significant benefits for anti-aging, tissue repair, and overall cellular health.",
    mechanismOfAction: "Stimulates growth factor production and activates cellular repair mechanisms. Modulates cellular signaling pathways involved in regeneration and anti-aging processes.",
    useCases: ["Anti-Aging", "Cellular Repair", "Tissue Regeneration", "Longevity"],
    benefits: ["Enhanced cellular repair", "Anti-aging effects", "Improved tissue regeneration", "Better cellular health"],
    dosageRange: "100-500 mcg daily",
    administration: ["Subcutaneous"],
    halfLife: "Several hours",
    sources: [
    ...
    warnings: ["Research purposes only", "Monitor for side effects"],
    sideEffects: ["Injection site reactions", "Mild fatigue", "Possible immune activation"],
    molecularFormula: "Variable",
    molecularWeight: "Variable",
    atomCount: 0,
    yearDiscovered: "2000s",
  ...
  },
  {
    id: "selank",
    name: "Selank",
    category: ["Mood & Cognition Enhancement", "Anxiety Reduction"],
    shortDescription: "A synthetic peptide that reduces anxiety and enhances cognitive function.",
    fullDescription: "Selank is a synthetic peptide derived from tuftsin that has been shown to reduce anxiety and enhance cognitive function. It works by modulating neurotransmitter systems and reducing stress response. Research demonstrates significant benefits for anxiety reduction, mood improvement, and cognitive enhancement.",
    mechanismOfAction: "Modulates GABA and serotonin systems to reduce anxiety and stress response. Enhances cognitive function through neuroprotective and neurotrophic effects.",
    useCases: ["Anxiety Reduction", "Mood Enhancement", "Cognitive Function", "Stress Management"],
    benefits: ["Reduced anxiety", "Improved mood", "Enhanced cognition", "Better stress management"],
    dosageRange: "200-600 mcg daily",
    administration: ["Subcutaneous", "Intranasal"],
    halfLife: "30-60 minutes",
    sources: [
      {
    ...
    warnings: ["Research purposes only", "Monitor mood changes"],
    sideEffects: ["Mild sedation", "Dizziness", "Possible mood changes"],
  ...
  },
  {
    id: "ll-37",
    name: "LL-37",
    category: ["Immune Enhancement", "Wound Healing & Recovery", "Antimicrobial"],
    shortDescription: "A natural antimicrobial peptide that enhances immune function and wound healing.",
    fullDescription: "LL-37 is a naturally occurring antimicrobial peptide that plays a crucial role in innate immunity and wound healing. It has broad-spectrum antimicrobial activity and promotes tissue repair. Research demonstrates significant benefits for immune enhancement, wound healing, and antimicrobial protection.",
    mechanismOfAction: "Disrupts bacterial cell membranes and modulates immune response. Promotes wound healing through growth factor stimulation and antimicrobial activity.",
    useCases: ["Immune Enhancement", "Wound Healing", "Antimicrobial Protection", "Tissue Repair"],
    benefits: ["Enhanced immunity", "Improved wound healing", "Antimicrobial protection", "Better tissue repair"],
    dosageRange: "50-200 mcg daily",
    ...
    warnings: ["Research purposes only", "Monitor immune response"],
    sideEffects: ["Injection site reactions", "Mild immune activation", "Possible inflammation"],
    molecularFormula: "C185H340N60O31",
    molecularWeight: "4493.0 g/mol",
    atomCount: 616,
    yearDiscovered: "1995",
    legalStatus: "Research Only (US/EU)",
    structure2D: "/placeholder-molecule.svg"
  },
  {
    id: "oxytocin",
    name: "Oxytocin",
    category: ["Mood & Cognition Enhancement", "Social Enhancement", "Stress Reduction"],
    shortDescription: "The 'love hormone' that enhances social bonding and reduces stress.",
    fullDescription: "Oxytocin is a naturally occurring peptide hormone that plays a crucial role in social bonding, trust, and stress reduction. It's often called the 'love hormone' due to its effects on social behavior and emotional processing. Research demonstrates significant benefits for social enhancement, stress reduction, and emotional well-being.",
    mechanismOfAction: "Binds to oxytocin receptors in the brain to modulate social behavior, trust, and stress response. Enhances emotional processing and social bonding.",
    useCases: ["Social Enhancement", "Stress Reduction", "Mood Improvement", "Emotional Processing"],
    benefits: ["Enhanced social bonding", "Reduced stress", "Improved mood", "Better emotional processing"],
    dosageRange: "10-50 IU daily",
    ...
    warnings: ["Research purposes only", "Monitor emotional changes"],
    sideEffects: ["Mild sedation", "Dizziness", "Possible emotional changes"],
  ...
  {
    id: "neuropeptide-y-antagonists",
    name: "Neuropeptide Y Antagonists",
    category: ["Fat Loss & Recomposition", "Appetite Control"],
    shortDescription: "Compounds that block NPY to reduce appetite and promote fat loss.",
    fullDescription: "Neuropeptide Y (NPY) antagonists are compounds that block the action of NPY, a potent appetite-stimulating peptide. By inhibiting NPY activity, they can reduce appetite and promote fat loss. Research demonstrates significant benefits for weight management, appetite control, and metabolic regulation.",
    mechanismOfAction: "Block NPY receptors to reduce appetite stimulation and food intake. Modulate feeding behavior and metabolic regulation through central nervous system mechanisms.",
    useCases: ["Appetite Control", "Weight Management", "Fat Loss", "Metabolic Regulation"],
    benefits: ["Reduced appetite", "Enhanced fat loss", "Better weight management", "Improved metabolism"],
    dosageRange: "Variable by compound",
    ...
    warnings: ["Research purposes only", "Monitor appetite changes"],
    sideEffects: ["Reduced appetite", "Possible nausea", "Mood changes"],
    molecularFormula: "Variable",
    molecularWeight: "Variable",
    atomCount: 0,
    yearDiscovered: "2000s",
