          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="bg-purple-50/70 rounded-xl p-6 border border-purple-200/50">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm mb-4">
                <label className="text-gray-600">
                  Total peptide mg
                  <input id="rc-mg" type="number" step="0.01" className="w-full mt-1 px-3 py-2 bg-white border border-purple-200 rounded-lg text-gray-800 focus:border-purple-400 focus:outline-none transition-colors"></input>
                </label>
                <label className="text-gray-600">
                  Diluent mL
                  <input id="rc-ml" type="number" step="0.01" className="w-full mt-1 px-3 py-2 bg-white border border-purple-200 rounded-lg text-gray-800 focus:border-purple-400 focus:outline-none transition-colors"></input>
                </label>
                <label className="text-gray-600">
                  Desired amount mg
                  <input id="rc-need" type="number" step="0.001" className="w-full mt-1 px-3 py-2 bg-white border border-purple-200 rounded-lg text-gray-800 focus:border-purple-400 focus:outline-none transition-colors"></input>
                </label>
                <button id="rc-go" className="col-span-1 mt-6 px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-200 font-semibold">
                  Calculate
                </button>
              </div>
              <div id="rc-out" className="text-sm text-gray-600 p-3 bg-white/60 rounded-lg border border-purple-200/50 min-h-[60px] flex items-center"></div>
            </div>
            ...
            <div className="bg-purple-50/70 rounded-xl p-6 border border-purple-200/50">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm mb-4">
                <label className="text-gray-600">
                  Vial mg
                  <input id="sp-mg" type="number" step="0.01" className="w-full mt-1 px-3 py-2 bg-white border border-purple-200 rounded-lg text-gray-800 focus:border-pink-400 focus:outline-none transition-colors"></input>
                </label>
                <label className="text-gray-600">
                  Total diluent mL
                  <input id="sp-ml" type="number" step="0.01" className="w-full mt-1 px-3 py-2 bg-white border border-purple-200 rounded-lg text-gray-800 focus:border-pink-400 focus:outline-none transition-colors"></input>
                </label>
                <label className="text-gray-600">
                  mL per spray
                  <input id="sp-per" type="number" step="0.001" className="w-full mt-1 px-3 py-2 bg-white border border-purple-200 rounded-lg text-gray-800 focus:border-pink-400 focus:outline-none transition-colors" defaultValue="0.1"></input>
                </label>
                <button id="sp-go" className="col-span-1 mt-6 px-4 py-2 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-lg hover:from-pink-600 hover:to-rose-600 transition-all duration-200 font-semibold">
                  Calculate
                </button>
              </div>
              <div id="sp-out" className="text-sm text-gray-600 p-3 bg-white/60 rounded-lg border border-purple-200/50 min-h-[60px] flex items-center"></div>
            </div>
          </div>
        </section>
